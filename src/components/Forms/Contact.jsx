    ...
    return (
        <section className={styles.contactSection}>
            <div className={styles.formWrapper}>
                ...
                <p className={styles.paragraph}>Send me a message with some details and I will reply to you as soon as
                    possible</p>
            ...
            <div className={styles.socialMediaContact}>
                <div className={styles.contactBox}>
                    ...
                    <a href="https://www.linkedin.com/in/frontend-developer-seo-expert-peterwolf/"
                       ...
                       rel="noreferrer-noopener"><img className={styles.socialIcon} src={LinkedInIcon} height="100px"
                                                      alt="Linkedin Profile Link to Peter Wolf"/></a>
                </div>
                <div className={styles.contactBox}>
                    <h1>Block your 30 Min talk!</h1>
